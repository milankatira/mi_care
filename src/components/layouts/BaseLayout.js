...
const BaseLayout = ({ children, title = "" }) => {
  ...
  async function validateUser(
    url = "https://staging.miicube.info/user/associatedSeniors",
    data = ""
  ) {
  ...
  async function GetDashboard_data(
    url = "https://staging.miicube.info/carehome/getCareHomeDashbordInfo?",
    data = {}
  ) {
  ...
  useEffect(() => {
    ...
    setData(sessionStorage.getItem("assocSenior"));
  }, [assoc, sessionStorage, validateUser]);
                ...
                <header className="container-fluid">
                  <Row>
                    <Col sm={6} className="d-flex align-items-center px-0">
                      ...
                      <h3 className="mb-0 mx-3 text-muted font-weight-light">
                        |
                      </h3>
                      <Dropdown className="ml-0 carehome-dropdown">
                        <Dropdown.Toggle className="ml-0 pl-0">
                          {state}{" "}
                          <img width={20} src={ArrowDownCircle} alt="icon" />
                        </Dropdown.Toggle>
                    ...
                    <Col sm={6} className="d-flex px-0">
                      ...
                      <img
                        src={
                          ...
                          JSON.parse(sessionStorage.getItem("user")).srngmi
                        }
                        alt="profile"
